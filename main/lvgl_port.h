...
#include "esp_heap_caps.h"   // Asegura las flags MALLOC_CAP_*

#ifndef LVGL_PORT_BUFFER_MALLOC_CAPS
// Para panel RGB: usar SRAM interna de 8 bits (mejor rendimiento)
// Si más tarde usas SPI/I80 con DMA, ve la nota de abajo.
